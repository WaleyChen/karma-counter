...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([Karma karma] == nil) [Karma setKarma:0];
    ...
    viewControllerIdentifier = ([Nickname nickname] == nil) ? @"NicknameViewController" : @"KarmaViewController";
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"iOS_karma_waley" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"iOS_karma_waley.sqlite"];
